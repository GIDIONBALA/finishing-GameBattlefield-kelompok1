...
public class BattleShips {
    ...
    public static void menyebarKapalAmerika(){
        ...
        for (int i = 1; i <= BattleShips.kapalAmerika; ) {
            ...
            if((x >= 0 && x < numRows) && (y >= 0 && y < numCols) && (grid[x][y] == " "))
            {
                ...
                System.out.println("kamu tidak boleh menempatkan dua atau lebih kapal di tempat yang sama");
            else if((x < 0 || x >= numRows) || (y < 0 || y >= numCols))
                System.out.println("kamu tidak dapat memenpatkan kapal di luar " + numRows + " by " + numCols + " koordinat");
        }
        tampilanMapLaut();
    }
    ...
    public static void menyebarKapalChina(){
        ...
        for (int i = 1; i <= BattleShips.kapalChina; ) {
            ...
            {
                grid[x][y] =   "#";
                System.out.println(i + ". MENYEBAR kapal "+i);
                i++;
            }
        }
        tampilanMapLaut();
    ...
    public static void giliranAmerika(){
        ...
        do {
            ...
            if ((x >= 0 && x < numRows) && (y >= 0 && y < numCols)) //valid guess
            {
                ...
                {
                    System.out.println("Duarrrrr! Amerika menenggelamkan salah satu Kapal China!");
                    grid[x][y] = "!"; //Hit mark
                    --BattleShips.kapalChina;
                }
                else if (grid[x][y] == "@") {
                    System.out.println("astuget, Amerika menenggelamkan kapalnya sendiri wkwkw");
                    grid[x][y] = "x";
                    --BattleShips.kapalAmerika;

                }
                else if (grid[x][y] == " ") {
                    System.out.println("Maaf, Amerika kurang beruntung kanrna salah sasaran");
                    grid[x][y] = "-";
                }
            }
            else if ((x < 0 || x >= numRows) || (y < 0 || y >= numCols))  //invalid guess
                System.out.println("kamu tidak boleh menenpatkan kapal di luar" + numRows + " by " + numCols + " koordinat");
